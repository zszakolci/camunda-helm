...
helm template dev camunda/camunda-platform --version 8.2.17 --namespace camunda --values camunda-platform/separate-ingress-values-8.2.yaml > templates/camunda-8.2.17.yaml
...
#kubectl apply -n camunda -f templates/camunda-8.2.17.yaml
