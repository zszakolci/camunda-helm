...
kind delete cluster --name camunda-platform-8.3
kind create cluster --config cluster/kind-cluster-config.yaml --name camunda-platform-8.3
...
helm template dev camunda/camunda-platform -n camunda --values camunda-platform/separate-ingress-values-8.3.yaml > templates/camunda-8.3.1.yaml
